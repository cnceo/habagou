...
$(document).ready(function () {
	...
	//小狗走动左到右
    function move_left2right(obj){
        obj.attr('src','/res/image/farm/00.gif')

        obj.stop().animate({'left':'60%'},6000,function(){
            obj.attr('src','/res/image/farm/01.gif')
            obj.stop().animate({'left':'15%'},6000,function(){
                move_left2right(obj)
            })
        })
    }
    //小狗走动左到右
    function move_right2left(obj){
        obj.attr('src','/res/image/farm/01.gif')
            ...
            if( num == ''){
                ...
                if(!re.test(num)){
                    ...
                    BizCall(
                        ...
                        function(data){
                            var n = data
                            var img = $(list[addyangIndex]).find('img');
                            ...
                            $(list[addyangIndex]).append(imgHtml);
                            
                            var left2right = $(list[addyangIndex]).find('.left2right')
					        move_left2right(left2right)
					        
					        var right2left = $(list[addyangIndex]).find('.right2left')
					        move_right2left(right2left)
                ...
                if( num == ''){
                    ...
                    if(!re.test(num)){
                        ...
                        BizCall(
                            ...
                            function(data){
                                var n = data
                                var img = $(list[weiyangIndex]).find('img');
                                var imglen = img.length;
                                var addImgLen = n - imglen;
                                var imgHtml = '';
                                if( addImgLen == 1){
                                ...
                                $(list[weiyangIndex]).append(imgHtml);
                                
                                var left2right = $(list[weiyangIndex]).find('.left2right')
						        move_left2right(left2right)
						        
						        var right2left = $(list[weiyangIndex]).find('.right2left')
						        move_right2left(right2left)
    ...
    //框框弹出开始
    $(document).on("click", ".new_gcn ul li span.li_click", function (e) {
        e.stopPropagation();
