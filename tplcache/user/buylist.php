...
class user_buylist_cache extends \bjphp\vendor\ui\CachePage
{
	public function run($uicontext)
	{
		...
		$this->do_html("\r\n\t\t\t\t\t\t\t");
		$v11=( ($this->get_prop($this->_this,"status")) == (3) );
		if( $this->is_true($v11) ){
		$this->do_html("\r\n\t\t\t\t\t\t\t交易完成\r\n\t\t\t\t\t\t\t");
		}
		$this->do_html("\r\n\t\t\t\t\t\t\t");
		$v12=( ($this->get_prop($this->_this,"status")) == (4) );
		if( $this->is_true($v12) ){
		$this->do_html("\r\n\t\t\t\t\t\t\t交易失败\r\n\t\t\t\t\t\t\t");
		}
		$this->do_html("\r\n\r\n\t\t\t\t\t\t</dt>\r\n\t\t\t\t\t</dl>\r\n\t\t\t\t\t");
		...
		$v13=( $this->get_prop($this->_this,"prev_page") );
		$this->do_html($this->encode($v13));
		$this->do_html("\" class=\"p_left\" title=\"上一页\"></a><span>");
		$v14=( $this->get_prop($this->_this,"pageindex") );
		$this->do_html($this->encode($v14));
		$this->do_html("/");
		$v15=( $this->get_prop($this->_this,"totalpage") );
		$this->do_html($this->encode($v15));
		$this->do_html("</span><a href=\"");
		$v16=( $this->get_prop($this->_this,"next_page") );
