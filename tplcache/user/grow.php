...
class user_grow_cache extends \bjphp\vendor\ui\CachePage
{
	public function run($uicontext)
	{
		...
		foreach($v1 as $v2=>$v3){
			...
			$this->_key=$v2;
		$this->do_html("\r\n\t\t\t\t<li>\r\n\t\t\t\t\t<span>");
		$v5=( $this->get_prop($this->_this,"num") );
		$this->do_html($this->encode($v5));
		$this->do_html("</span>\r\n\t\t\t\t\t<span>");
		$v6=( $this->get_prop($this->_this,"basic") );
		$this->do_html($this->encode($v6));
		$this->do_html("</span>\r\n\t\t\t\t\t<span>");
		$v7=( $this->get_prop($this->_this,"breeder") );
		$this->do_html($this->encode($v7));
		$this->do_html("</span>\r\n\t\t\t\t\t<span>");
		$v8=( $this->get_prop($this->_this,"level") );
		$this->do_html($this->encode($v8));
		$this->do_html("</span>\r\n\t\t\t\t\t<span>");
		$v9=( $this->get_prop($this->_this,"total") );
		$this->do_html($this->encode($v9));
		$this->do_html("</span>\r\n\t\t\t\t\t<span>");
		$v10=( $this->get_prop($this->_this,"bonedate") );
		...
		$this->do_html("\r\n\r\n\r\n\t\t\t</ul>\r\n\t\t\t<div class=\"fenye\">\r\n\t\t\t\t<a href=\"");
		$v11=( $this->get_prop($this->_this,"prev_page") );
		$this->do_html($this->encode($v11));
		$this->do_html("\"><span class=\"fenYeLeft\"></span></a>\r\n\t\t\t\t<span class=\"fenshu\"><em>");
		$v12=( $this->get_prop($this->_this,"pageindex") );
		$this->do_html($this->encode($v12));
		$this->do_html("</em>/");
		$v13=( $this->get_prop($this->_this,"totalpage") );
		$this->do_html($this->encode($v13));
		$this->do_html("</span>\r\n\t\t\t\t<a href=\"");
		$v14=( $this->get_prop($this->_this,"next_page") );
